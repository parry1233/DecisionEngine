...
class Varaible extends React.Component {
    ...
    renderVariable = () => {
        ...
        return variables.map((eachVariable) => ( <
            ...
            onClick = {
                () => this.edit(eachVariable) } >
            Edit <
            /button> <
            button className = "btn btn-danger mr-2"
            onClick = {
                () => this.onDelete(eachVariable) } >
            Delete <
            /button> <
            /td> <
            /tr>
    ...
    render() {
        return ( <
            ...
            /div> {
                this.state.modal ? ( <
                    VariableModal activeCard = { this.state.activeCard }
                ...
                this.state.new_modal ? ( <
                    AddVariableModal fk = { this.props.case_info.id }
                    existDType = { this.state.allDType }
