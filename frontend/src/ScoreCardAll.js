    ...
    renderScoreCard = () => {
        ...
        return cards.map((eachCard)=>(
            <tr key = {eachCard["id"]}>
                ...
                <td>
                    <button className="btn btn-primary disabled mr-2" onClick={() => this.edit(eachCard,1, this.case_info.id)}>
                        Variable
                    </button>
                    <button className="btn btn-warning disabled mr-2" onClick={() => this.edit(eachCard,2, this.case_info.id)}>
                        Score
                    </button>
